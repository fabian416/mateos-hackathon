...
| Email para Marcos | **PENDIENTE** | marcos@mateos.tech |
...
- **Email corporativo:** marcos@mateos.tech
...
[accounts.gaucho]
default = true
email = "marcos@mateos.tech"
display-name = "Marcos - MateOS"
# Ajusta estos valores segun tu proveedor de email
backend.type = "imap"
backend.host = "imap.gmail.com"
backend.port = 993
backend.login = "marcos@mateos.tech"
backend.passwd.cmd = "security find-generic-password -a marcos@mateos.tech -s himalaya-mateos -w"
backend.encryption = "tls"

message.send.backend.type = "smtp"
message.send.backend.host = "smtp.gmail.com"
message.send.backend.port = 465
message.send.backend.login = "marcos@mateos.tech"
message.send.backend.passwd.cmd = "security find-generic-password -a marcos@mateos.tech -s himalaya-mateos -w"
...
ingress:
  - hostname: marcos.mateos.tech
    service: http://localhost:3000
  - service: http_status:404
CFEOF

# Agrega el DNS en Cloudflare
cloudflared tunnel route dns marcos marcos.mateos.tech
...
1. Desde tu email personal, manda un email a `marcos@mateos.tech`
...
| Dominio mateos.tech | ~$12 USD/ano (~$1/mes) | Si ya lo tenes, $0 |
