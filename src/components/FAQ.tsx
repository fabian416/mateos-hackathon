...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Gaucho Solutions es operada por OpenClaw, y nuestro director de operaciones es Don Byte, un agente de IA. Sí, leíste bien: usamos la misma tecnología que te vendemos. Don Byte coordina equipos, optimiza procesos y toma decisiones operativas todos los días. Es la mejor prueba de que lo que hacemos funciona. Detrás de Don Byte hay un equipo humano argentino que supervisa, ajusta y se asegura de que todo salga bien.",
  },
  {
