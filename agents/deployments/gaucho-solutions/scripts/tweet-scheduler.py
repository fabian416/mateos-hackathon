...
HONESTY_RULES = (
    "\n\nREGLAS OBLIGATORIAS:"
    "\n- Gaucho Solutions es una empresa nueva. NO decir que tenemos X clientes, X empresas, ni métricas inventadas."
...
CONTENT_PROMPTS = {
    ...
    "agente": (
        "Generá UN tweet presentando uno de los agentes de Gaucho Solutions aplicado a un negocio concreto.\n"
    ...
    "noticias": (
        ...
        "Tu trabajo es elegir LA MÁS relevante para Gaucho Solutions y escribir UN tweet comentándola.\n"
