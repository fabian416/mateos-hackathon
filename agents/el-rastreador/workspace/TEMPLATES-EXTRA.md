...
> 1. Te pasa solo con [app/sitio de {{CLIENT_NAME}}] o con otras paginas tambien?
...
- Si solo falla con {{CLIENT_NAME}} → verificar si hay incidentes activos. Si no, pedir mas datos.
...
>
> Avisa si con alguno de esos pasos anda. {{SUPPORT_SIGNATURE}}
...
> Hola [nombre], que te aparece cuando intentas entrar? Si podes mandar captura del error, mejor. Tambien decime: antes podias entrar sin problema o es la primera vez? {{SUPPORT_SIGNATURE}}
...
> Proba cerrar sesion, limpiar el cache del navegador, y volver a entrar. Si usas la app, cerra y abrila de nuevo. {{SUPPORT_SIGNATURE}}
...
> Hola [nombre], cuando decis que esta lento: es todo o alguna parte en particular? (por ej: la carga inicial, una accion especifica, etc.) Y desde cuando te pasa? {{SUPPORT_SIGNATURE}}
...
>
> Si en incognito anda bien, el problema es una extension o el cache. {{SUPPORT_SIGNATURE}}
...
> Hola [nombre], que datos esperabas ver y que te aparece? Si podes mandar captura de lo que ves (y de lo que deberia verse, si lo tenes) me ayuda mucho a rastrear el problema. {{SUPPORT_SIGNATURE}}
...
> Proba hacer un refresh forzado: en PC es Ctrl+Shift+R, en la app cerra y volve a abrir. Si siguen los datos viejos, cerra sesion, limpia cache y volve a entrar. {{SUPPORT_SIGNATURE}}

#### Solucion L1 (dato no se guardo)

> Intenta cargar la informacion de nuevo. Si al guardar te aparece algun error, mandame captura del mensaje. {{SUPPORT_SIGNATURE}}
...
> Proba de nuevo verificando que los datos de la tarjeta esten correctos. Si te sigue fallando, proba con otro metodo de pago si es posible. {{SUPPORT_SIGNATURE}}
...
> Hola [nombre], con que servicio se deberia conectar y que error te aparece? Desde cuando dejo de funcionar? {{SUPPORT_SIGNATURE}}
...
> Proba desconectar la integracion y volver a conectarla. En general: anda a Configuracion > Integraciones > [servicio] > Desconectar, y despues conectala de nuevo. {{SUPPORT_SIGNATURE}}
