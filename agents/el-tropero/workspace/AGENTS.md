...
|----------|------|----------------|
| **Necesidad real** | Alto | ¿El prospecto tiene un problema concreto que {{CLIENT_NAME}} resuelve? ¿O está "solo mirando"? |
...
| **Fit con oferta** | Alto | ¿Lo que necesita está dentro del scope de {{CLIENT_NAME}}? ¿O está pidiendo algo que no hacemos? |
...
**Respuesta**: Compartir solo información que sea pública (lo que está en la web de {{CLIENT_NAME}}). Ante la duda, decir "te lo confirmo" y consultar al operador.
